/**
 * Filesystem backend — direct file system access to the Obsidian vault.
 *
 * This is the original implementation extracted from tools.js.
 * All I/O goes through Node.js fs/promises + glob.
 */
...
// Re-export the pure extractTags function
